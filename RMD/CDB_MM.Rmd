...
ts_San_Share_cdb <- xts::xts(round(plot_vector$vect_share_cdb2,digits = 2),order.by = dt_vct2)
ts_delta_cdb <- xts::xts(round(plot_vector$vect_delta_cdb2, digits = 2),order.by = dt_vct2)
